...
<div class="section bg-cover page-banner-area d-flex align-items-center" style="background-image: url(assets/images/slides/2.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-12 animate__animated animate__FadeInRight service_image">
                <img src="assets/images/services2/gum_surgery.png" alt="" class="img-fluid" style="width:300px; height: 300px; border-radius:8px;">
            </div>
            ...
            <div class="about-wrapper">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="about-img ">
                            <img src="assets/images/services2/gum_surgery.png" alt="" class="img-fluid">
                        </div>
                ...
                This treatment is often necessary for individuals with advanced gum disease (periodontitis), receding gums, excessive gum tissue, or bone loss caused by infections. By addressing these concerns, gum surgery reduces the risk of tooth loss and enhances overall dental health.
                            ...
                            <p><strong> 🔹 Gingivectomy –</strong> Removes excess gum tissue to improve appearance and oral hygiene.</p>
                            <p><strong>🔹 Gingivoplasty –</strong> Reshapes the gums for a more natural look.</p>

                            <p><strong>🔹 Flap Surgery – </strong>Treats deep gum infections by cleaning the roots and reducing pocket depth.</p>
                            <p><strong>🔹 Gum Grafting – </strong>Covers exposed roots due to gum recession, reducing sensitivity and preventing</p>
                            </p>
                        </div>
