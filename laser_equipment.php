...
<div class="section bg-cover page-banner-area d-flex align-items-center" style="background-image: url(assets/images/slides/4.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="about-img service_image">
                            ...
                            <!-- <img src="assets/images/services2/laser_equipment.png" alt="" class="img-fluid"> -->
                             <img src="assets/images/services2/laser_equipment.png" alt="">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="about-text" data-animation="fadeInUp" data-delay="0.9s">
                            ...
                            <p>
                            Laser treatment in dentistry offers a precise and minimally invasive approach to procedures like teeth whitening, gum surgery, and cavity treatment. By using focused light energy, lasers promote faster healing, reduce discomfort, and minimize the need for traditional methods such as drilling or sutures, making it an excellent option for patients seeking efficient and gentle care
</p>
                            <p>
