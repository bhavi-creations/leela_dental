...
<div class="section bg-cover page-banner-area d-flex align-items-center" style="background-image: url(assets/images/slides/ct_scan.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <!--  Page Banner Title Start -->
                <div class="page-banner-title text-center">
                    <h2 class="title">Dental CT Scan</h2>
                    <!--  Page Banner Breadcrumb Start -->
                    <ul class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">dental-CT-Scan</li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-12 animate__animated animate__FadeInRight">
                <img src="assets/images/services2/ct_scan.png" alt="" class="img-fluid"  >
            </div>
