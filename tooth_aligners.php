...
<div class="section bg-cover page-banner-area d-flex align-items-center" style="background-image: url(assets/images/slides/aligners.png);">
    <div class="container ">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-banner-title text-center">
                    ...
                    <ul class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Tooth-aligners</li>
                    </ul>
