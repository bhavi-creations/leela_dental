...
<main class="blogs_content">
  ...
  <div class="container">
    <div class="filter_buttons redirect_section mt-5">
      ...
      <a href="blogs.php?service=Rootcanal"><button class="redirect_blog_srivice">Rootcanal</button></a>
      ...
      <a href="blogs.php?service=Lasers"><button class="redirect_blog_srivice"> Lasers</button></a>
      ...
      <a href="blogs.php?service=Composit Filler"><button class="redirect_blog_srivice">Composit Filler</button></a>
